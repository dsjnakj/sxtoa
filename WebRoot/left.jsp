		...
		<c:if test="${sessionScope.emp.empType == 2 }">			
			<dd>
				...
				<ul class="menuson">
					...
					<li><cite></cite><a href="department?method=findAll" target="rightFrame">部门管理</a><i></i></li>
					<li><cite></cite><a href="system/positionAdd.jsp" target="rightFrame">添加岗位</a><i></i></li>
					<li><cite></cite><a href="position?method=findAll2" target="rightFrame">岗位管理</a><i></i></li>
					<li><cite></cite><a href="employee?method=toAdd" target="rightFrame">添加员工</a><i></i></li>
					<li><cite></cite><a href="employee?method=findAll" target="rightFrame">员工管理</a><i></i></li>
				</ul>
			</dd>
			<dd>
			...
			<dd>
				...
				<ul class="menuson">
					...
					<li><cite></cite><a href="expense?method=toAudit" target="rightFrame">待审报销</a><i></i></li>
			...
			<dd>
				...
				<ul class="menuson">
					...
					<li><cite></cite><a href="inout/incomestatic.jsp" target="rightFrame">收入统计</a><i></i></li>
					<li><cite></cite><a href="expense/expenseList.jsp" target="rightFrame">查看支出</a><i></i></li>
