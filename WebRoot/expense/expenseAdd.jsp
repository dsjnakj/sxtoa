...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<base href="<%=basePath%>"/>	
		...
		<script type="text/javascript">
			...
			function addExpenseItem(id){
				...
				'</select></div></td>'+
				'<td><input name="amout" type="text" class="dfinput" /><i></i></td>'+
	...
	<body>
		...
		<div class="formbody">
			...
			<form action="expense?method=add" method="post">
			<ul class="forminfo">
				<li>
					<label>报销人</label>
				...
				-->
						...
						<li>
							...
							&nbsp;&nbsp;
							<input name="nextAuditorId" type="text" class="dfinput" value="${sessionScope.emp.mgr.empId }" readonly="readonly"  />
						</li>
					</li>
					<li>
						<label>总备注信息</label>
